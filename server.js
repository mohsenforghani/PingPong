        ...
        switch(data.type){
            ...
            case 'rematch':
                ...
                if (rematchRoom.player1 && rematchRoom.player2 &&
                    ...
                    rematchRoom.rematchRequests={};
                    send(rematchRoom.player1.ws,{type:'rematchAccepted'});
                    send(rematchRoom.player2.ws,{type:'rematchAccepted'});
                    rematchRoom.loop=setInterval(()=>gameLoop(ws._meta.roomId),1000/TICK_HZ);
                    rematchRoom.status='playing';
                } else {
                    const other = (rematchRoom.player1.ws===ws? rematchRoom.player2.ws : rematchRoom.player1.ws);
